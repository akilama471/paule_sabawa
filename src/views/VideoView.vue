...
const videoUrl = ref('https://www.youtube.com/watch?v=WWXaB8zolyI');
  ...
  <div class="flex flex-col items-center h-screen justify-center m-1">
    ...
    <div class="w-full max-w-3xl mx-auto bg-gray-900 rounded-lg shadow-lg overflow-hidden relative">
      ...
      <div class="plyr__video-wrapper">
        <div ref="player" class="plyr" data-plyr-provider="youtube" :data-plyr-embed-id="getYouTubeVideoId(videoUrl)"></div>
      </div>
    </div>
